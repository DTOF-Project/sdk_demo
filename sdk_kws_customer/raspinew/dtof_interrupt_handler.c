...
//     if (dtof_get_distance_result(&raw_data.result_info) != DTOF_RET_SUCCESS) {
//         printf("FIFO读取失败\n");
//         return;
//     }
...
// dtof_uint8_t device_id_h;
// dtof_distance_result_t result_info_h;

// void init_sensor_param(dtof_uint8_t* device_id_main, dtof_distance_result_t* result_info_main){
//     &device_id_h = device_id_main;
//     &result_info_h = result_info_main;
// }

// void set_distance_result(dtof_distance_result_t* result_info_main){
//     result_info_main
...
static void* dtof_interrupt_thread(void* arg) {
    ...
    while (signal_manager_should_continue()) {
        ...
        //     ret = dtof_get_fifo(device_id_h, NORMAL_DISTANCE_MODE, &result_info_h);
