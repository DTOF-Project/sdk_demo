...
#define DTOF_VERSION_CHIP_BATCH 4
#define DTOF_VERSION_CHIP_TYPE 2
#define DTOF_VERSION_CUSTOMER 8
#define DTOF_VERSION_MAJOR 2
#define DTOF_VERSION_MINOR 1
#define DTOF_VERSION_PATCH 6

#define STR_HELPER(x) #x
#define STR(x) STR_HELPER(x)

#define DTOF_VERSION_STRING STR(DTOF_VERSION_CHIP_BATCH) "." STR(DTOF_VERSION_CHIP_TYPE) "." STR(DTOF_VERSION_CUSTOMER) "." STR(DTOF_VERSION_MAJOR) "." STR(DTOF_VERSION_MINOR) "." STR(DTOF_VERSION_PATCH)
