...
DTOF_RET dtof_do_ft_calibration(dtof_uint16_t ft_cali_type, dtof_uint16_t ft_actual_param)
{
    ...
    dtof_ft_cali_param_t ft_cali_param_temp;
    ...
    if(DTOF_BIT_GET(ft_cali_type, DTOF_FT_CALIBRATE_REFSPAD))
    {
        ...
        cal_data.ref_spad_cal.otp_ref_spad_mask = ft_actual_param;
    ...
    {
        // 为 1 表示对空做校准
        ret = dtof_do_cross_talk_calibration(&cal_data.cross_talk_data, ft_actual_param);
