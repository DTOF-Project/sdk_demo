...
void dtof_output_distance_result(dtof_distance_result_t distance_result)
{
    ...
    switch (g_distance_mode)
    {
        ...
        {
            printf("%d, %d, %d, %d, %.6f, %d, %.6f, %.6f, %.6f, %.6f, %d, %d, %d, %d, %d\n",
                            ...
                            distance_result.ref_peak_hist, distance_result.ref_peak_nflash, distance_result.reflect_compensation, distance_result.ambient_compensation, distance_result.is_swap_peak);
            break;
        }
